    ...
    <main class="main">
        ...
        <div class="site-breadcrumb" style="background: url(assets/img/breadcrumb/01.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">Project Single</h2>
                <ul class="breadcrumb-menu">
                    <li><a href="index-2.html">Home</a></li>
                    <li class="active">Project Single</li>
                </ul>
            </div>
        </div>

        <div class="project-single-area py-120">
            <div class="container">
                <div class="project-single-wrapper">
                    <div class="row">
                        <div class="col-xl-4 col-lg-4">
                            <div class="project-sidebar">
                                <div class="widget project-sidebar-content">
                                    <h4 class="project-sidebar-title">Project Details</h4>
                                    <ul>
                                        <li>
                                ...
                                <div class="widget new-project">
                                    <h4>Need A Brand New Project?</h4>
                                    <a href="#" class="new-project-btn">Contact Now <i
                        ...
                        <div class="col-xl-8 col-lg-8">
                            <div class="project-details">
                                <div class="project-details-img mb-30">
                                    <img src="assets/img/project/single.jpg" alt="thumb">
                                </div>
                                <div class="project-details">
                                    <h3 class="mb-30">Web Design</h3>
                                    <p class="mb-20">
