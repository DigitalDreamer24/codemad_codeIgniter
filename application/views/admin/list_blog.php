                ...
                <form role="form" action="" method="get">
                    <div class="row">
                      <div class="form-group col-md-4">
                         <input type="text" name="title" class="form-control" placeholder="Search by Blog Title">
                      </div>
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="admin/dashboard/add_blog/<?= $value->id ?>">Edit</a>&nbsp;&nbsp;<a href="admin/dashboard/delete_blog/<?= $value->id ?>" onclick="return confirm('Are you sure you want to delete');">Delete</a></td>
                    </tr>
                    <?php $c++; } ?>
                  </tbody>
                </table>
