                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="admin/dashboard/add_subcategory/<?= $value->id ?>">Edit</a>&nbsp;&nbsp;<a href="admin/dashboard/delete_subcat/<?= $value->id ?>" onclick="return confirm('Are you sure you want to delete');">Delete</a></td>
                    </tr>
                    <?php $c++; } ?>
                  </tbody>
                </table>
